 ...
 */
final class Version20210527110853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD lieu_id INT DEFAULT NULL, DROP etat');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD etat TINYINT(1) NOT NULL, DROP lieu_id');
    }
}
